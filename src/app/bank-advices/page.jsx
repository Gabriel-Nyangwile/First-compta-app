        ...
        <tbody>
          ...
          {filtered.map(a => (
            <tr key={a.id} className="border-b">
              ...
              <td className="p-2">{ADVICE_TYPE_LABELS[a.adviceType] || a.adviceType}</td>
              ...
              <td className="p-2">
                {a.invoiceId ? <Link href={`/invoices/${a.invoiceId}`} className="underline text-blue-700">Facture client</Link> :
                 a.incomingInvoiceId ? <Link href={`/incoming-invoices/${a.incomingInvoiceId}`} className="underline text-orange-700">Facture fournisseur</Link> : "-"}
              </td>
              <td className="p-2">
                {a.authorizationId ? <Link href={`/authorizations/${a.authorizationId}`} className="underline text-purple-700">Consulter</Link> : "-"}
              </td>
              <td className="p-2">
